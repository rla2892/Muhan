        ...
        <br><br>
         <div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">아이디</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="${customer_member_dto.cus_id}" readonly></div>
		</div>
	 	
	 	<div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">닉네임</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="${customer_member_dto.cus_nickname}" readonly></div>
		</div>
...
<c:if test="${customer_member_dto.cus_gender eq 2 }">여자</c:if>" readonly>
		 ...
		 <div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">생년월일</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="<fmt:formatDate value="${customer_member_dto.cus_birth}" type="both" pattern="yyyy-MM-dd"/>" readonly></div>
		</div>	
	 	 	
	 	<div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">주소</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="${customer_member_dto.cus_address}" readonly></div>
		</div>
		
		<div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">상세주소</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="${customer_member_dto.cus_address2}" readonly></div>
		</div>
	 	
	 	<div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">이메일</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="${customer_member_dto.cus_email}" readonly></div>
		</div>
		
		<div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">전화번호</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="${customer_member_dto.cus_tel}" readonly></div>
		</div>
	 	
	 	<div class="form-group row">
		       <label for="nickname" class="col-sm-3 col-form-label">가입일자</label>
				<div class="col-sm-8"><input class="form-control" type="text" value="<fmt:formatDate value="${customer_member_dto.cus_reg_date}" type="both" pattern="yyyy-MM-dd"/>" readonly></div>
		</div>
