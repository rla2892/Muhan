...
@Controller
public class Cus_pay_store_search_location_Handler implements CommandHandler{

	@Resource
	private Store_member_Dao store_member_dao;
	
	@RequestMapping("/Cus_pay_store_search_location")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		return new  ModelAndView("cus/cus_cart/cus_pay_store_search_location");
	}
}
