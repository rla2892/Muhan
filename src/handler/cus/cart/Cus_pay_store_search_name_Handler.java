...
@Controller
public class Cus_pay_store_search_name_Handler implements CommandHandler{

	@Resource
	private Store_member_Dao store_member_Dao;
	
	@RequestMapping("/Cus_pay_store_search_name")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		count = store_member_Dao.getCountByName(keyword);
		...
		List<Store_member_DataBean> store_member_dtos2 = store_member_Dao.selectStoresByName(map);
		request.setAttribute("store_member_dtos", store_member_dtos2);
		request.setAttribute("keyword", keyword);
		
		
		return new  ModelAndView("cus/cus_cart/cus_pay_store_search_name");
	}
}
