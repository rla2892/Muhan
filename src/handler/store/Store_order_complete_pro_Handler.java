...
@Controller
public class Store_order_complete_pro_Handler implements CommandHandler {
	@Resource
	private Order_history_Dao order_history_dao;
	@RequestMapping("/Store_order_complete_pro")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		int result = order_history_dao.updateOrderStatus(map);
		
		request.setAttribute("result", result);
		
		return new ModelAndView("store/store_order_complete_pro");
	}
