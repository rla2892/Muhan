...
@Controller
public class Admin_menu_find_Handler2 implements CommandHandler{
	
	@Resource
	private Menu_Dao menu_dao;
	
	@RequestMapping("/Admin_menu_find2")
	@Override
...
int category;
		...
		return new ModelAndView("admin/admin_menu/admin_menu_find2");
	}
}
