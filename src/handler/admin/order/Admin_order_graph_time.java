...
@Controller
public class Admin_order_graph_time implements CommandHandler{
	@Resource
	...
	@RequestMapping("/Admin_order_graph_time")
	@Override
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		return new ModelAndView("admin/admin_order/admin_order_graph_time");
	}
}
