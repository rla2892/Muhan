...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////							
			...
			//로그 만들 반복 실행
			//년 단위 : 2015~2018
			output = new FileOutputStream("c:/home/event"+".txt");
...
///////////////////////////////////////////////////////////////////////////////////
//로그 쓰기 시작							
normal_random_int= (int) (normal_random.nextGaussian()*1+1);
if(year>=2017) {
	normal_random_int+=1;
	if(year>=2018) {
		normal_random_int+=1;
...
//order_no 존재
//랜덤 고객 생성
Cus_for_random cus_random=cus_objects.get(randombetween(1, 10000-1));
