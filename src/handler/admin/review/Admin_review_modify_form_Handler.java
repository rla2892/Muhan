...
@Controller
public class Admin_review_modify_form_Handler implements CommandHandler {
	
	@Resource
	private Review_Dao review_dao;
	
	@RequestMapping("/Admin_review_modify_form")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		return new ModelAndView("admin/admin_review/admin_review_modify_form");
	}
