...
@Controller
public class Admin_review_notice_detail_Handler implements CommandHandler{

	@Resource
	private Review_Dao review_dao;
	
	@RequestMapping("/Admin_review_notice_detail")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		review_dao.addHitsNotice(notice_no);
		
		return new ModelAndView("admin/admin_review/admin_review_notice_detail");
	}
}
